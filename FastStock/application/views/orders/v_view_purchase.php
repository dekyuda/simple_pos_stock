...
<div id="content-wrapper">
	...
	<div class="content-main">
			...
			<div class="stock_in">
				<div class="stock-in-header">
					...
					<div class="in-header">
						...
						<div class="right">
							<span>
								...
								<input type="date" readonly name="po_date" class="po_date" value="<?php echo $purchase['trans_stock_in']?>">
					...
					<div class="in-header">
						...
						<div class="right">
							<span><input type="text" readonly name="po_supplier" class="po_supplier" value="<?php echo $purchase['supplier']?>"></span>
						</div>
					</div>
				...
				<div class="stock-in-header2">	
					...
					<div class="in-header2">
						...
						<div class="right">
							<span><input type="text" readonly name="po_remark" class="po_remark" value="<?php echo $purchase['remark_stock_in']?>"></span>
						</div>
					</div>
			...
			<div class="stock-in-main">
				<div class="table">
					...
					<div class="tbody">	
						...
						<input type="text" readonly counter="1" name="product_cost[]" min="0" class="cost counter1" value="<?php echo number_format($purch->stock_cost, 0, ",", ".")?>">
						</div>
						<div class="cell cell4">
							<input type="number" readonly counter="1" name="product_qty[]" min="0" class="qty counter1" value="<?php echo $purch->stock_in_qty ?>">
						</div>
						...
						<div class="cell cell6">
							<input type="text" readonly counter="1" name="sub_total[]" class="sub_total counter1" value="<?php echo number_format($purch->stock_in_subtotal, 0, ",", ".") ?>">
						</div>
						<div class="cell cell7">
							<input type="number" readonly counter="1" name="product_disc[]" class="disc counter1" min=0 max=100 value="<?php echo $purch->stock_in_disc ?>">
						</div>
						<div class="cell cell8" align="center">
							<?php
								if($purch->stock_in_tax > 0){
									?>
						...
						<div class="cell cell9">
							<input type="text" readonly counter="1" name="total[]" class="total counter1" value="<?php echo number_format($purch->stock_in_total, 0, ",", ".") ?>">
						</div>
					</div> <!-- tbody -->
					<?php
						$no++;		
			...
			<div class="stock-in-footer">
				<div class="note">
					<label><b>Purchase Note.</b></label>
					<textarea name="po_note" class="po_note" readonly><?php echo $purchase['stock_in_notes'] ?></textarea>
				</div>
				...
				<div class="pay">
					...
					<div class="pay-main">
						<b><input type="text" align="right" readonly name="po_sub_total" class="po_sub_total" align="right" value="<?php echo number_format($purchase['total_cost'], 0, ",", ".")?>"></b>
					</div>
				</div>
				<div class="pay">
					<div class="pay-title">
	...
	<div class="print-main">
		<div class="print-header">
			...
			<div class="print-header-purchase">
				<b>Purchase # <?php echo $purchase['id_stock_in']?></b><br>
				<b><?php echo $purchase['trans_stock_in']?></b><br>
				Supplier : <?php echo $purchase['supplier']." / ".$purchase['delivery_status'] ?><br>
		...
		<div class="print-product">
			...
			<div class="print-product-header">
				...
				<div class="tb3">Unit Cost (Rp.)</div>
			...
			<div class="print-product-detail">
				<div class="tb1 ppd" align="right"><?php echo $purchdet->stock_in_qty?> - Pcs</div>
				<div class="tb2 ppd"><?php echo $purchdet->product_name?></div>
				<div class="tb3 ppd"><?php echo number_format($purchdet->stock_cost, 0, ",", ".") ?></div>
				<div class="tb4 ppd"><?php 
						echo $purchdet->stock_in_disc; 
					?> %</div>
				<div class="tb5 ppd"><?php 
					if($purchdet->stock_in_tax > 0){
					...
					?></div>
				<div class="tb6 ppd"><?php echo number_format($purchdet->stock_in_total, 0, ",", ".") ?></div>
			</div>
			<?php	
			}
			?>
		...
		<div class="print-footer">
			<div class="footer-grandtotal">
				...
				<div class="grand-number">
					<div class="gt1"><?php echo number_format($purchase['total_cost'], 0, ",", ".")?></div>
